...
def draw_win(cars, road, world, GEN):  # x e y sono le coordinate della macchina migliore
    ...
    py.display.update()
    # blit dello sfondo subito dopo l'update così se ho delle draw prima della draw_win non vengono coperte dallo sfondo
    ...
    while run:
        ...
        while(i < len(cars)):
            ...
            if t > 10 and (car.detectCollision(road) or y > world.getBestCarPos()[1] + BAD_GENOME_TRESHOLD or y > y_old or car.vel < 0.1):
                ...
                ge[i].fitness += -(y - y_old)/100 + \
                    car.vel*SCORE_VEL_MULTIPLIER
